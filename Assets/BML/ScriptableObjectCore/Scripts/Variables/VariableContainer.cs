...
namespace BML.ScriptableObjectCore.Scripts.Variables
{
    ...
    {
        All = UserSettings | ResetOnRestartGame | ResetOnStartAnyLevel | ResetOnStartLevel0 | ResetOnStartLevel1,
        None = 0,
        UserSettings = 1 << 0,
        // Placeholders are left here for room add more entries without needing to modify the existing mappings
        // Placeholder = 1 << 1,
        // Placeholder = 1 << 2,
        // Placeholder = 1 << 3,
        // Placeholder = 1 << 4,
        ...
        // Placeholder = 1 << 8,
        // Placeholder = 1 << 9,
        ResetOnRestartGame = 1 << 10,
        ResetOnStartAnyLevel = 1 << 11,
        ResetOnStartLevel0 = 1 << 12,
        ResetOnStartLevel1 = 1 << 13,
    }
